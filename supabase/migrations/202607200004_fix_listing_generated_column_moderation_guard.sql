...
-- Exclude search_text_normalized from OLD/NEW JSON comparisons so governed RPCs can
-- update only their authorized fields without weakening moderation protections.
