    ...
    <section className="rawaj-detail-safety" aria-labelledby="rawaj-detail-safety-title">
      <div className="rawaj-detail-safety__heading">
        ...
        <div>
          ...
          <p>
            {text(
              "رواج لا يتوسط في الدفع أو التسليم.",
              "RAWAJ does not mediate payment or delivery.",
            )}
          </p>
        </div>
      </div>
      ...
      <ul>
        ...
        <li>
          {text(
            "افحص السلعة وتحقق من بياناتها قبل الدفع.",
            "Inspect the item and verify its details before paying.",
          )}
        </li>
        <li>
          {text(
            "لا ترسل عربونًا قبل التأكد من البائع والسلعة.",
            "Do not send a deposit before verifying the seller and item.",
          )}
        </li>
      </ul>
