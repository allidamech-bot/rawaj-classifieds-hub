...
const sections = [
  ...
  {
    h: "البلاغات والإشراف",
    p: "سيتم لاحقاً تفعيل منظومة بلاغات وإشراف تتيح للفريق مراجعة الإعلانات والمستخدمين المخالفين وإزالتهم أو إيقافهم. حالياً لا توجد منظومة إشراف فعلية.",
  },
  {
  ...
  },
  {
    ...
    p: "في هذه المرحلة لا يوجد تسجيل دخول حقيقي ولا قاعدة بيانات فعلية، ولا يتم حفظ أي بيانات حساسة. تعمل المنصة كنموذج عرض فقط (Prototype).",
  },
  {
    h: "تعديل الشروط",
