...
const sections = [
  ...
  {
    h: "البلاغات والإشراف",
    p: "يتم تجهيز منظومة بلاغات وإشراف مرتبطة بـ Supabase، لكن تنفيذ الإجراءات الإدارية الكاملة يبقى خاضعاً للصلاحيات والسياسات عند التفعيل.",
  },
  {
  ...
  },
  {
    ...
    p: "تم تجهيز أساس تسجيل الدخول والأدوار عبر Supabase، بينما ما زالت الإعلانات والصور والرسائل والدفع في مراحل تأسيس أو عرض تجريبي حتى اكتمال السياسات والجداول المطلوبة.",
  },
  {
    h: "تعديل الشروط",
