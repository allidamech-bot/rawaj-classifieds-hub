...
const sections = [
  {
    ...
    p: "رَوَاج ما زال في مرحلة تأسيس إنتاجية تدريجية. تسجيل الدخول والأدوار يستخدمان Supabase، بينما تبقى أجزاء الإعلانات والصور والرسائل والدفع غير مكتملة أو تجريبية حتى تفعيل جداولها وسياساتها.",
  },
  {
