...
export const sellerVerificationQueue = [
  {
    ...
    verification: "قيد المراجعة",
    featured: "متجر مميز",
    docs: "مستندات توثيق placeholder",
    date: "2026-06-18",
    review: "2026-06-25",
...
export const featuredListingQueue = [
  {
    ...
    featured: "مميز",
    duration: "7 أيام",
    dates: "بداية/نهاية placeholder",
    payment: "مقبول placeholder",
  ...
  },
  {
    ...
    featured: "منتهي",
    duration: "3 أيام",
    dates: "منتهي placeholder",
    payment: "مرفوض placeholder",
    reviewer: "—",
    owner: "نعم",
...
export const pendingListings = [
  {
    ...
    admin: "ليان الخطيب",
    note: "ملاحظة داخلية placeholder",
  },
  {
    id: "L-pending-02",
