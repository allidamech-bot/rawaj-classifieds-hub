...
expect("public BottomNav must remain exactly five items", (bottomNav.match(/\bto:\s*"/g) ?? []).length === 5);
expect("admin routes must stay hidden from public BottomNav", primaryNavigation.includes('"/admin"'));
